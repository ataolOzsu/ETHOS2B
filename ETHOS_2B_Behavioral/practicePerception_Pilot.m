...
function [R_V,R_P] = practicePerception_Pilot(subID,orientations,V)
...
text = ['In this part of the experiment you will detect and will NOT imagine the gratings \n ',...
    'while again looking at dynamicly changing noise (so keep your eyes open!). \n ',...
    'Your task is to first indicate how vivid you saw the gratings\n ',...
...
text = ['After that, another grating will be presented which is tilted with \n'...
    ...
    'or clockwise (rightward) [RM] with respect to the perceived grating. \n \n',...
...
for iOri = 1:nOri
    ...
    text = sprintf('During the next trials, please try to detect and NOT imagine Grating %s (see below) \n ,\n Keep your eyes fixated on the fixation cross as much as possible. \n \n [Press any key to start] \n ',cues{iOri});
    ...
    while count < nTrialsC && iTrial < nTrials
        ...
        % Vividness rating
        text = 'How visible was the grating? \n 1[LL] - 4[LI]';
                frames = 60;
                RM = 1;
                noiseNo = 1;
                [~, ~] = sliderRating_forNIMADET(w, text, xCenter*2, yCenter*2,RM,orientations(iOri), noiseNo,frames,rect,visibility );
        ...
        if mod(iTrial,nRemind) == 0
            ...
            text = sprintf('Just a reminder of what the gratings look like! \n You should detect and NOT imagine Grating %s during this block. \n \n [Press any key to continue] \n ',cues{iOri});
